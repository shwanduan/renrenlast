...
Page({
        ...
        a.getCache("isIpx") ? e.setData({
            ...
            if (1 != a.error) {
                if (0 == a.error) {
                    ...
                    }), i.wxParse("wxParseData", "html", a.bargain.content, e, "0"), "" == a.bargain.rule || null == a.bargain.rule ? i.wxParse("wxParseDataRule", "html", a.bargain_set.rule, e, "0") : i.wxParse("wxParseDataRule", "html", a.bargain.rule, e, "0"), 
    ...
    cutPrice: function() {
        ...
        a.checkAuth(function() {
            var a = "/pages/auth/index", r = i, e = r.data.bargainid, n = r.data.mid;
            t.get("bargain/bargain", {
                id: e,
                ajax: 151,
                mid: n
            }, function(t) {
                -1 != t.error ? 1 != t.error ? 0 == t.error && t.cutPrice ? r.setData({
                    layer: !0,
                    cutPrice: t.cutPrice
                }) : wx.redirectTo({
                    url: a
    ...
    countDown: function(a, t, i) {
        var r = parseInt(Date.now() / 1e3), e = parseInt((a > r ? a : t) - r), n = Math.floor(e / 86400), s = Math.floor((e - 24 * n * 60 * 60) / 3600), o = Math.floor((e - 24 * n * 60 * 60 - 3600 * s) / 60), g = [ n, s, o, Math.floor(e - 24 * n * 60 * 60 - 3600 * s - 60 * o) ];
        if (this.setData({
            time: g
        }), "istime") {
            var d = "";
    ...
    onShareAppMessage: function(a) {
        var t = this.data.bargainid, i = this.data.mid, r = this.data.bargain_share, e = {
            title: r.content || "帮砍价",
            path: "/bargain/bargain/bargain?id=" + t + "&mid=" + i,
            success: function(a) {},
            fail: function(a) {}
        };
