function u(u) {
    if (Array.isArray(u)) {
        for (var n = 0, a = Array(u.length); n < u.length; n++) a[n] = u[n];
        return a;
    }
    return Array.from(u);
}
...
function n(u) {
    var n = [], a = u.length > 2 ? 2 : u.length;
    n.push(u);
    for (var i = 1; i < a; i++) n.push(u.slice(0, i));
    return n;
}

function a(u, n) {
    for (var a = [], i = 0; i < u.length; i++) for (var e = i + 1; e <= u.length; e++) a.push(n ? u.slice(i, e).join("") : u.slice(i, e));
    return a;
}
...
var i = {
    ...
    han: "汉韩含旱寒汗涵函喊憾罕焊翰邯撼瀚憨捍酣悍鼾邗颔蚶晗菡旰顸犴焓撖",
    ang: "昂仰盎肮",
...
module.exports = {
    pinyinDict: e,
    convertToPinyin: function(u) {
        for (var n, a = (u = (u = (u = u.replace(/\s+/g, " ")).replace(/[\uD83C|\uD83D|\uD83E][\uDC00-\uDFFF][\u200D|\uFE0F]|[\uD83C|\uD83D|\uD83E][\uDC00-\uDFFF]|[0-9|*|#]\uFE0F\u20E3|[0-9|#]\u20E3|[\u203C-\u3299]\uFE0F\u200D|[\u203C-\u3299]\uFE0F|[\u2122-\u2B55]|\u303D|[\A9|\AE]\u3030|\uA9|\uAE|\u3030/gi, "")).toUpperCase()).split(""), i = "", o = [], g = 0; g < a.length; g++) " " === (n = a[g]) ? i && (o.push(i), 
        i = "") : e[n] ? (i && (o.push(i), i = ""), o.push(e[n])) : i += n;
        return i && o.push(i), u = o.join(" ");
    },
    comparePinyinArray: function(u, n) {
        return u.join("") < n.join("") ? 1 : -1;
    },
    nameToWordsStructure: function(a) {
        for (var i, o = (a = (a = (a = a.replace(/\./g, " ").replace(/\s+/g, " ")).replace(/[\uD83C|\uD83D|\uD83E][\uDC00-\uDFFF][\u200D|\uFE0F]|[\uD83C|\uD83D|\uD83E][\uDC00-\uDFFF]|[0-9|*|#]\uFE0F\u20E3|[0-9|#]\u20E3|[\u203C-\u3299]\uFE0F\u200D|[\u203C-\u3299]\uFE0F|[\u2122-\u2B55]|\u303D|[\A9|\AE]\u3030|\uA9|\uAE|\u3030/gi, "")).toLowerCase()).split(""), g = "", h = [], r = 0; r < o.length; r++) " " === (i = o[r]) ? g && (h.push({
            key: g,
            values: n(g)
        }), g = "") : e[i] ? (g && (h.push({
            key: g,
    ...
    wordsStructureToIndexes: function(u) {
        var n = [];
        return u.forEach(function(u) {
            for (var a = u.key, i = u.values[0], e = 1; e <= i.length; e++) n.push(i.slice(0, e));
            i !== a && n.push(a);
        }), Array.from(new Set(n));
    },
    nameToWordsStructureNew: function(u) {
        for (var n, a = (u = (u = (u = u.replace(/\./g, " ").replace(/\s+/g, " ")).replace(/[\uD83C|\uD83D|\uD83E][\uDC00-\uDFFF][\u200D|\uFE0F]|[\uD83C|\uD83D|\uD83E][\uDC00-\uDFFF]|[0-9|*|#]\uFE0F\u20E3|[0-9|#]\u20E3|[\u203C-\u3299]\uFE0F\u200D|[\u203C-\u3299]\uFE0F|[\u2122-\u2B55]|\u303D|[\A9|\AE]\u3030|\uA9|\uAE|\u3030/gi, "")).toLowerCase()).split(""), i = [], o = [], g = [], h = "", r = "", s = 0; s < a.length; s++) " " === (n = a[s]) ? h && (i.push(h), 
        o.push(h), g.push(h[0]), h = "") : (r = e[n]) ? (h && (i.push(h), o.push(h), g.push(h[0]), 
        h = ""), i.push(n), o.push(r), g.push(r[0])) : h += n;
        return h && (i.push(h), o.push(h), g.push(h[0])), {
            origin: i,
            pinyin: o,
            initial: g
        };
    },
    wordsStructureToIndexesNew: function(u) {
        var n = [];
        return n = n.concat(a(u.origin.join(""))), n = n.concat(a(u.pinyin, !0)), n = n.concat(a(u.initial.join(""))), 
        Array.from(new Set(n));
    }
};